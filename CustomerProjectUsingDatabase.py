#BLL Start
import pymysql
con=pymysql.connect(host="localhost",user="root",password="mvj02670339",database="mysql")
class Customer:
...
btnShowAll=tkinter.Button(root,text="Show All",width=6,command=btnShowAll_Click)
btnShowAll.grid(row=6,column=0,columnspan=4)
